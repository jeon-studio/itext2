 ...
 */
public class AddWatermarkPageNumbers2Test{
    /**
     * Reads the pages of an existing PDF file, adds pagenumbers and a watermark.
    ...
    public  void main() throws Exception {
            ...
            PdfStamper stamp = new PdfStamper(reader,PdfTestBase.getOutputStream("watermark_pagenumbers2.pdf"));
...
//            	over.showText("page(페이지) " + i);
            ...
            //OCG테스트
			PdfLayer pdfLayer = new PdfLayer( "layer1", stamp.getWriter() );
			//SPEC 381p
			pdfLayer.setPrint( "Watermark", false );
            over.beginLayer( pdfLayer );
        	over.beginText();
        	over.setFontAndSize(bf, 18);
            over.showTextAligned(Element.ALIGN_LEFT, "듀플DUPLICATE OF AN EXISTING PDF DOCUMENT", 30, 600, 0);
            over.endText();
            //OCG테스트
            over.endLayer();
